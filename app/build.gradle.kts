...
dependencies {
 ...
 implementation("androidx.camera:camera-core:1.5.0"); implementation("androidx.camera:camera-camera2:1.5.0"); implementation("androidx.camera:camera-lifecycle:1.5.0"); implementation("androidx.camera:camera-view:1.5.0")
